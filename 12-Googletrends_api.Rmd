...
print_used_packages(find_used_packages("12-Googletrends_api.Rmd"))
```
...
trend <- gtrends(
  keyword = "corona symptome",
  geo = c("DE", "AT"),
  time = "2020-01-01 2021-04-27",
  gprop = "web"
)
...
ggplot(trend_df, aes(x = date, y = hits, group = geo, col = geo)) +
  geom_line(size = 2) +
